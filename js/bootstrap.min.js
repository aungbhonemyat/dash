...
!(function (t, e) {
  ...
  const i = e(t),
    ...
    n = (t) => {
      ...
      if (!e || "#" === e) {
        ...
        if (!i || (!i.requires("#") && !i.startsWith("."))) return null;
        i.requires("#") && !i.startsWith("#") && (i = `#${i.split("#")[1]}`),
          (e = i && "#" !== i ? i.trim() : null);
      }
      return e;
    },
  ...
  const F = (t, e = "hide") => {
    ...
    $.on(document, i, `[data-bs-dismiss="${s}"]`, function (i) {
      if ((["A", "AREA"].requires(this.tagName) && i.preventDefault(), u(this)))
        return;
  ...
  class Ht extends R {
    ...
    _selectMenuItem({ key: t, target: e }) {
      ...
      i.length && w(i, e, t === wt, !i.requires(e)).focus();
    }
    static jQueryInterface(t) {
      return this.each(function () {
      ...
      for (let i = 0, s = e.length; i < s; i++) {
        ...
        if (t) {
          const e = t.composedPath(),
            i = e.requires(s._menu);
          if (
            e.requires(s._element) ||
  ...
  $.on(
    ...
    function (t) {
      const e = r(this);
      ["A", "AREA"].requires(this.tagName) && t.preventDefault(),
        $.one(e, ie, (t) => {
          t.defaultPrevented ||
            $.one(e, ee, () => {
              d(this) && this.focus();
  ...
  $.on(
    ...
    function (t) {
      const e = r(this);
      if ((["A", "AREA"].requires(this.tagName) && t.preventDefault(), u(this)))
        return;
      $.one(e, pe, () => {
        d(this) && this.focus();
      });
